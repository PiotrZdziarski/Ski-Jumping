@extends('layouts.app')
@section('title') {{$player->player}} @endsection
@section('content')
    <!-- Section Title -->
    <div class="section-title single-player"
         style="background:url('../img/slide/{{$player->slide_image}}'); background-size: cover; background-position: 50% 50%; background-position-y: 50%;">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h1>
                        <text-block row="player"
                                    api_link='@php echo getenv('APP_URL')."/api/player_show/$id" @endphp'></text-block>
                    </h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-xl-3">
                        ...
                        <div class="item-player single-player">
                            <div class="head-player">
                                <img src='{{asset("img/players/$player->player_image")}}' alt="{{$player->player}}">
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <strong>NATIONALITY:</strong> <span>
                                            <text-block row="country"
                                                        api_link='@php echo getenv('APP_URL')."/api/player_show/$id" @endphp'></text-block> </span>
                                    </li>
                                    <li>
                                        <strong>AGE:</strong>
                                        <span>
                        ...
                        <div class="panel-box">
                            ...
                            <ul class="list-panel">
                                <li>
                                    <p>Weight <span><text-block row="weight"
                                                                api_link='@php echo getenv('APP_URL')."/api/player_show/$id" @endphp'></text-block></span>
                                    </p>
                                </li>
                                <li>
                                    <p>Height <span><text-block row="height"
                                                                api_link='@php echo getenv('APP_URL')."/api/player_show/$id" @endphp'></text-block></span>
                                    </p>
                                </li>
                                <li>
                                    <p>Nationality <span><text-block row="country"
                                                                     api_link='@php echo getenv('APP_URL')."/api/player_show/$id" @endphp'></text-block></span>
                                    </p>
                                </li>
                                <li>
                                    <p>Birth <span><text-block row="born"
                                                               api_link='@php echo getenv('APP_URL')."/api/player_show/$id" @endphp'></text-block></span>
                                    </p>
                                </li>
                            </ul>
                                ...
                                <div class="panel-box padding-b">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xl-4">
                                            <img src='{{asset("img/players/$player->player_image_2")}}' alt="{{$player->player}}">
                                        </div>

                                        <div class="col-lg-12 col-xl-8 pre-line margin-top-minus-20">
                                            {{$player->description}}
                                        </div>
                                    </div>
                                </div>
